                ...
                <div className="w-full max-w-lg lg:max-w-xs">
                  ...
                  <div className="relative">
                    ...
                    <input
                      id="search"
                      name="search"
                      className="block w-full rounded-md border border-gray-300 bg-white py-2 pl-10 pr-3 leading-5 placeholder-gray-500 shadow-sm focus:border-gray-600 focus:placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-gray-600 sm:text-sm"
                      placeholder="Search"
                      type="search"
                    />
                  </div>
                            ...
                            {attachments.map((attachment) => (
                              ...
                              >
                                ...
                                <div className="ml-4 flex-shrink-0">
                                  <a href={attachment.href} className="font-medium text-gray-600 hover:text-gray-500">
                                    Download
                                  </a>
                                </div>
                              </li>
